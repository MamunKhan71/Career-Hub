        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="p-10 space-y-4 border border-dashed border-[#E8E8E8] rounded-lg">
                    ...
                    <h1 className="text-2xl font-bold text-[#474747]">Technical Database Engineer</h1>
                    <p className="text-[#757575] text-xl font-medium">Google LLC</p>
                    <div className="flex gap-4">
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Remote</button>
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Full Time</button>
                    </div>
                    <div className="flex gap-4 items-center">
                        <div className="flex gap-2 items-center">
                            ...
                            <span className="text-[#757575] font-semibold text-xl">Dhaka, Bangladesh</span>
                        </div>
                        <div className="flex gap-2 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <span className="text-[#757575] font-semibold text-xl">Salary : 100K - 150K</span>
                        </div>
                    </div>
                    <div>
                        <button className="font font-extrabold text-white btn bg-gradient-to-r from-[#7e90fe] to-[#9873ff]">View Details</button>
                    </div>
                </div>
                <div className="p-10 space-y-4 border border-dashed border-[#E8E8E8] rounded-lg">
                    <div>
                    ...
                    <h1 className="text-2xl font-bold text-[#474747]">Senior Product Designer</h1>
                    <p className="text-[#757575] text-xl font-medium">Netflix</p>
                    <div className="flex gap-4">
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Remote</button>
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Full Time</button>
                    </div>
                ...
                <div className="p-10 space-y-4 border border-dashed border-[#E8E8E8] rounded-lg">
                    <div>
                        <img src="assets/logo/tesla.png" alt="" />
                    </div>
                    <h1 className="text-2xl font-bold text-[#474747]">Software Engineer</h1>
                    <p className="text-[#757575] text-xl font-medium">Tesla</p>
                    <div className="flex gap-4">
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Remote</button>
                        <button className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 btn">Full Time</button>
                    </div>
            ...
            <div className="flex items-center justify-center">
                <button className="mb-28 mt-4 font font-extrabold text-white btn bg-gradient-to-r from-[#7e90fe] to-[#9873ff]">See All Jobs</button>
            </div>
        </div>
    );
};
