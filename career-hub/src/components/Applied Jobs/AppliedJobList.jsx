    ...
    return (
        <div className="mb-8">
            <div className="container mx-auto">
                <div className="border border-[#E8E8E8] rounded-xl p-8 flex gap-6 items-center justify-around space-y-4">
                    ...
                    <div className="flex-1 space-y-3">
                        ...
                        <div className="flex gap-4">
                            <button
                                className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 py-2 btn">{remote_or_onsite}
                            </button>
                            <button
                                className="font-extrabold text-blue-600 border border-blue-600 rounded-lg px-4 py-2 btn">{job_type}
                            </button>
                        </div>
                            ...
                            <div className="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="#757575" strokeWidth="1.5" strokeLinecap="round"
                                ...
                                <span className="font-semibold text-[#757575] text-lg">{location}</span>
                            </div>
                            <div className="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                                ...
                                <span className="font-semibold text-[#757575] text-lg">{salary}</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex-1 flex items-center justify-center">
                        <button
                            className="font font-extrabold text-white btn bg-gradient-to-r from-[#7e90fe] to-[#9873ff]">View Details
                        </button>
                    </div>
                </div>
            </div>
